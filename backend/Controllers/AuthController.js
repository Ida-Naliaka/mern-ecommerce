...
const registerUser = expressAsyncHandler(async (req, res) => {
  ...
  if (user) {
    ...
    let mailOptions = {
      ...
      <p>Thank you for signing up to Ecommerce. Please confirm your email by clicking on the following link</p>
      <a href=http://localhost:3001/auth/${user.confirmationCode}> Click here</a>
      </div>`,
    };
